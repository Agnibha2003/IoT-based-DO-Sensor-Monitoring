...
import { GaugeCircle, TrendingUp, TrendingDown, Activity, AlertCircle } from 'lucide-react';
    ...
    const initialLoad = async () => {
      try {
        ...
        if (hist.length > 0) {
          ...
          const latestVal = latest && latest.corrected_do != null ? Number(latest.corrected_do).toFixed(2) : '0.00';
                ...
                <ResponsiveContainer width="100%" height="100%">
                  ...
                  <defs>
                    <linearGradient id="colorNewDO" x1="0" y1="0" x2="0" y2="1">
                      ...
                      <stop offset="80%" stopColor="#166534" stopOpacity={0.2}/>
                      <stop offset="100%" stopColor="#14532d" stopOpacity={0.05}/>
                    </linearGradient>
                    <linearGradient id="strokeGradientNew" x1="0%" y1="0%" x2="100%" y2="0%">
                    ...
                    <filter id="shadowNew">
                      <feDropShadow dx="0" dy="3" stdDeviation="5" floodColor="#4ade80" floodOpacity="0.4"/>
                    </filter>
                  </defs>
                  <CartesianGrid 
                    strokeDasharray="1 3" 
                  ...
                  <Tooltip 
                    contentStyle={{
                      ...
                      borderRadius: '12px',
                      boxShadow: '0 8px 32px rgba(74, 222, 128, 0.25), 0 4px 16px rgba(0, 0, 0, 0.1)',
                    ...
                    formatter={(value, name) => [`🟢 ${value} mg/L`, t.newDOConcentration]}
                  />
                  <Area
                    type="monotone"
                    dataKey="value"

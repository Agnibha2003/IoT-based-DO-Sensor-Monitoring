      ...
      try {
        ...
        if (!lastTimestamp || latest.timestamp !== lastTimestamp) {
          const newDataPoint = {
            ...
            value: latest.do_concentration != null ? Number(latest.do_concentration).toFixed(2) : '0.00',
          ...
          const latestVal = latest.do_concentration != null ? Number(latest.do_concentration).toFixed(2) : '0.00';
          setCurrentValue(latestVal);
        ...
        <Card className="hover:shadow-xl transition-all duration-500 border-border/50 hover:border-primary/30 bg-card/50 backdrop-blur-sm">
          ...
          <CardContent>
            <div className="h-96 relative">
              <div className="absolute inset-0 bg-linear-to-br from-cyan-500/5 via-transparent to-blue-500/5 rounded-lg"></div>
